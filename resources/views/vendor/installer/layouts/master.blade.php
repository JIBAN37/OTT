...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('assets/libraries')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('assets/videos')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('assets/webfonts')}}">
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            <script src="{{asset('js/homeSliders.js')}}"></script>
