...
<html lang="en">
  <head>
    ...
    <!-- Plyr CSS -->
    <link rel="stylesheet" href="./assets/libraries/plyr/plyr.css" />
  ...
  <body>
    ...
    <main id="website">
      ...
      <section class="single__series padding-top-70 single__page">
        <div class="featured__area">
          <img
            src="./assets/images/featured-img.jpg"
            alt="Featured image"
            class="cover__img"
          />
        </div>
        <div class="single__header">
          <div class="show__credentials">
            <h2 class="single__title">টান</h2>
            <div class="time__duration">
              <span class="count">105</span>
              মিনিট
            </div>
            |
            <div class="type">রোমান্টিক ড্রামা</div>
              ...
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    ...
                    <h2 class="part__title">দ্বিতীয় জীবন পর্ব ০১</h2>
                    <p class="part__desc">
                      মিতু একজন কর্মজীবী মা। একদিন কাজের ফাঁকে একটি ফোন আসে
                      মিতুর কাছে। সে জানতে পারে, তার মা মারা গেছেন। এরপর মিতুর
                      জীবন কীভাবে বদলে যায়, জানতে দেখুন আনিসুল হক রচিত ‘দ্বিতীয়
                      জীবন’, শুধু চরকিতে।
                    </p>
                  </div>
                </div>
      ...
      <!-- Signle series modal starts -->
      <div
        class="modal fade single__show__modal"
        id="showModal"
        data-bs-backdrop="static"
        data-bs-keyboard="false"
        tabindex="-1"
          ...
          <div class="modal-content">
            ...
            <div class="modal-body p-0">
              <video
                ...
                playsinline
                controls
                data-poster="./assets/images/tan.jpg"
              >
              ...
              <div class="row video__desc">
                <div class="col-6">
                  <h2 class="modal__title">
                    <span class="season__epi text-uppercase">S1:E1</span>
                    দ্বিতীয় জীবন পর্ব 01
                  </h2>
                </div>
                <div class="col-6">
                  <div class="next__epi">
                    ...
                    <div class="next__epi__desc">
                      <h3 class="next__text">Next</h3>
                      <h3 class="next__title">দ্বিতীয় জীবন পর্ব 02</h3>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <!-- Single series modal ends -->

      <!-- Trending shows starts -->
      <section class="splide__shows single__splider">
        <h2 class="splide__heading text-uppercase">Recommended For You</h2>
    ...
    <!-- Plyr JS -->
    <script src="./assets/libraries/plyr/plyr.js"></script>
