...
<html lang="en">
  ...
  <body>
    ...
    <main id="website">
      ...
      <!-- Movies shows starts -->
      <section class="series padding-x section-padding-y">
        <h2 class="section__title">Bramatic Series</h2>

        <ul class="show__list py-2 show__list__sm">
          <li class="show__item">
            <a href="./single-series.html" class="show__link"></a>
            <div class="show__type text-uppercase">Free</div>
            <img
