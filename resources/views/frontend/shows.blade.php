...
<html lang="en">
  ...
  <body>
    ...
    <main id="website">
      ...
      <!-- Movies shows starts -->
      <section class="other-shows padding-x section-padding-y">
        <h2 class="section__title">Music Videos</h2>

        <ul class="show__list py-2">
          <li class="show__item">
            <a href="./single-show.html" class="show__link"></a>
            <div class="show__type text-uppercase">Premium</div>
            <img
            ...
            />
            <div class="content">
              <a href="./single-show.html" class="play__btn">
                <i class="fa-solid fa-play"></i>
              </a>
              <button class="wishlist__btn">
                <i class="fa-solid fa-plus"></i>
              </button>
              <h2 class="show__title text-white">টান</h2>
            </div>
          </li>
          <li class="show__item">
            <a href="./single-show.html" class="show__link"></a>
