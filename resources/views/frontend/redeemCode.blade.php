...
<html lang="en">
  ...
  <body>
    ...
    <main id="website">
      ...
      <!-- redeem code starts -->
      <section class="redeem__code">
        <div class="container">
          <div class="code__sample">
            <p class="text">
              আপনার ছয় মাস বা এক বছরের সাবস্ক্রিপশন কোড (যেমন: CRK11-XXXXXXX,
              CRK12-XXXXXXX) থাকলে এখানে ব্যবহার করুন।
            </p>
            <p class="disclaimer">
              দয়া করে এখানে প্রোমো কোড (যেমন: XXXX50) ব্যবহার করবেন না।
              সাবস্ক্রিপশন প্যাকেজ কেনার সময় পেমেন্ট করার আগে প্রোমো কোড ব্যবহার
              করে ডিসকাউন্ট উপভোগ করুন।
            </p>
          </div>

          <div class="redeem__code__form">
            <form action="#" method="post">
              ...
              <button type="submit" class="btn btn__submit text-uppercase">
                Validate
              </button>
            </form>
          </div>
