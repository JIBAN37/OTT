...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="./assets/libraries/splide/css/splide.min.css"
    />
  ...
  <body>
    ...
    <main id="website">
          ...
          <div class="splide__track">
            <ul class="splide__list">
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/fluidSlider/tan.jpg"
                  data-small-src="./assets/images/fluidSlider/tan-small.jpg"
                  alt="Slide"
                  class="splide__img"
                />
                <div class="splide__inner">
                  <div class="splide__header">
                    <h2 class="title">টান</h2>
                  </div>
                  <div class="splide__content">
                    <span class="type">রোমান্টিক ড্রামা</span>
                    |
                    <span class="tag">NR</span>
                    |
                    <span class="duration">105 মিনিট</span>
                  </div>
                  <div class="splide__footer">
                    <a href="#" class="cta-btn watch-btn">দেখুন</a>
                    <a href="#" class="cta-btn trailler-btn">Trailler</a>
                  </div>
              ...
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/fluidSlider/khachar-vitor-achin-pakhi.jpg"
                  data-small-src="./assets/images/fluidSlider/khachar-vitor-achin-pakhi-small.jpg"
                  alt="Slide"
                  class="splide__img"
                />
                <div class="splide__inner">
                  <div class="splide__header">
                    <h2 class="title">খাঁচার ভিতর অচিন পাখি</h2>
                  </div>
                  <div class="splide__content">
                    <span class="type">থ্রিলার</span>
                    |
                    <span class="tag">NR</span>
                    |
                    <span class="duration">93 মিনিট</span>
                  </div>
                  <div class="splide__footer">
                    <a href="#" class="cta-btn watch-btn">দেখুন</a>
                    <a href="#" class="cta-btn trailler-btn">Trailler</a>
              ...
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/fluidSlider/3-in-1.jpg"
                  data-small-src="./assets/images/fluidSlider/3-in-1-small.jpg"
                  alt="Slide"
                  class="splide__img"
                />
                <div class="splide__inner">
                  <div class="splide__header">
                    <h2 class="title">3 in 1 Combo Pack</h2>
                  </div>
                  <div class="splide__content">
                    <span class="type">Chorki Originals</span>
                  </div>
                  <div class="splide__footer">
                    <a href="#" class="cta-btn watch-btn">দেখুন</a>
                  </div>
              ...
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/fluidSlider/munshigiri.jpg"
                  data-small-src="./assets/images/fluidSlider/munshigiri-small.jpg"
                  alt="Slide"
                  class="splide__img"
                />
                <div class="splide__inner">
                  <div class="splide__header">
                    <h2 class="title">মুন্সিগিরি</h2>
                  </div>
                  <div class="splide__content">
                    <span class="type">ডিটেক্টিভ ড্রামা</span>
                    |
                    <span class="tag">NR</span>
                    |
                    <span class="duration">86 মিনিট</span>
                  </div>
                  <div class="splide__footer">
                    <span><a href="#" class="cta-btn watch-btn">দেখুন</a></span>
                    <span
                      ><a href="#" class="cta-btn trailler-btn"
                        >Trailler</a
                      ></span
                    >
                  </div>
              ...
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/fluidSlider/movie-series.jpg"
                  data-small-src="./assets/images/fluidSlider/movie-series-small.jpg"
                  alt="Slide"
                  class="splide__img"
                />
                <div class="splide__inner">
                  <div class="splide__header">
                    <h2 class="title">Movie Series Combo</h2>
                  </div>
                  <div class="splide__content">
                    <span class="type">Chorki Originals</span>
                  </div>
              ...
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/fluidSlider/unlowkik.jpg"
                  data-small-src="./assets/images/fluidSlider/unlowkik-small.jpg"
                  alt="Slide"
                  class="splide__img"
                />
                <div class="splide__inner">
                  <div class="splide__header">
                    <h2 class="title">ঔঊলৌকিক</h2>
                  </div>
                  <div class="splide__content">
                    <span class="type">সাইকোলোজিক্যাল ড্রামা</span>
                    |
                    <span class="episodes">Episodes-5</span>
                  </div>
                  <div class="splide__footer">
                    <a href="#" class="cta-btn watch-btn">দেখুন</a>
                  </div>
              ...
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/fluidSlider/youtumer.jpg"
                  data-small-src="./assets/images/fluidSlider/youtumer-small.jpg"
                  alt="Slide"
                  class="splide__img"
                />
                <div class="splide__inner">
                  <div class="splide__header">
                    <h2 class="title">ইউটিউমার</h2>
                  </div>
                  <div class="splide__content">
      ...
      <section class="splide__shows">
        <h2 class="splide__heading">বাজার গরম</h2>
        <div class="splide" id="trendingShows">
          <div class="splide__track">
            <ul class="splide__list">
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/tan.jpg"
                  alt="Slide"
                  class="splide__img"
                />
              ...
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/shaticup.jpg"
                  alt="Slide"
                  class="splide__img"
                />
                <div class="show__quality">Premium</div>
              ...
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/rehana-maryam-noor.jpg"
                  alt="Slide"
                  class="splide__img"
                />
                <div class="show__quality">Premium</div>
              ...
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/jago-bahe.jpg"
                  alt="Slide"
                  class="splide__img"
                />
                <div class="show__quality">Premium</div>
              ...
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/prem-puran.jpg"
                  alt="Slide"
                  class="splide__img"
                />
                <div class="show__quality">Premium</div>
              ...
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/movie-series.jpg"
                  alt="Slide"
                  class="splide__img"
                />
                <div class="splide__inner">
              ...
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/ekjon-telapoka.jpg"
                  alt="Slide"
                  class="splide__img"
                />
                <div class="show__quality">Premium</div>
      ...
      <!-- Superhit shows starts -->
      <section class="splide__shows splide__vertical">
        <h2 class="splide__heading">সিনেমা সুপারহিট</h2>
        <div class="splide" id="superHitShows">
          <div class="splide__track">
            <ul class="splide__list">
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/fluidSlider/tan-small.jpg"
                  alt="Slide"
                  class="splide__img"
                />
                <div class="show__quality">Premium</div>
              ...
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/fluidSlider/3-in-1-small.jpg"
                  alt="Slide"
                  class="splide__img"
                />
                <div class="show__quality">Premium</div>
              ...
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/fluidSlider/unlowkik-small.jpg"
                  alt="Slide"
                  class="splide__img"
                />
                <div class="show__quality">Premium</div>
              ...
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/fluidSlider/youtumer-small.jpg"
                  alt="Slide"
                  class="splide__img"
                />
                <div class="show__quality">Premium</div>
              ...
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/fluidSlider/munshigiri-small.jpg"
                  alt="Slide"
                  class="splide__img"
                />
                <div class="show__quality">Premium</div>
              ...
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/fluidSlider/movie-series-small.jpg"
                  alt="Slide"
                  class="splide__img"
                />
                <div class="show__quality">Premium</div>
              ...
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
                <img
                  src="./assets/images/fluidSlider/khachar-vitor-achin-pakhi-small.jpg"
                  alt="Slide"
                  class="splide__img"
                />
                <div class="splide__inner">
      ...
      <!-- Trending shows starts -->
      <section class="splide__shows">
        <h2 class="splide__heading">ফরেন ফিল্ম</h2>
        <div class="splide" id="trendingShows2">
          <div class="splide__track">
            <ul class="splide__list">
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
      ...
      <!-- Trending shows starts -->
      <section class="splide__shows">
        <h2 class="splide__heading">সিরিজ : না দেখলে মিস</h2>
        <div class="splide" id="trendingShows3">
          <div class="splide__track">
            <ul class="splide__list">
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
      ...
      <section class="splide__shows splide__vertical">
        <h2 class="splide__heading">সিনেমা সুপারহিট</h2>
        <div class="splide" id="superHitShows2">
          <div class="splide__track">
            <ul class="splide__list">
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
      ...
      <!-- Superhit shows starts -->
      <section class="splide__shows splide__vertical">
        <h2 class="splide__heading">সামান্য প্রামাণ্য</h2>
        <div class="splide" id="superHitShows3">
          <div class="splide__track">
            <ul class="splide__list">
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
      ...
      <!-- Trending shows starts -->
      <section class="splide__shows">
        <h2 class="splide__heading">কুল ক্ল্যাসিকস</h2>
        <div class="splide" id="trendingShows4">
          <div class="splide__track">
            <ul class="splide__list">
              <li class="splide__slide">
                <a href="#" class="splide__overlay"></a>
    ...
    <!-- Splide JS -->
    <script src="./assets/libraries/splide/js/splide.min.js"></script>
