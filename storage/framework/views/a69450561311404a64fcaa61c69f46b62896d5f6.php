<?php $__env->startSection('head_title', trans('words.popular_movies').' | '.getcong('site_name') ); ?>
...
<div class="page-header">
  <div class="vfx_page_header_overlay">
    <div class="container">
      ...
      <li><?php echo e(trans('words.popular_movies')); ?></li>
      </ul>  
    </div>
    </div>
  </div>
           ...
           <?php $__currentLoopData = explode(",",$home_sections->section3_popular_movie); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $popular_movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>            
            ...
            <div class="col-md-2 col-sm-4 col-xs-6">
              ...
              <div class="thumb-wrap"> 
                <img src="<?php echo e(URL::to('upload/source/'.App\Movies::getMoviesInfo($popular_movie,'video_image_thumb'))); ?>" alt="Movie Thumb"> <?php if(App\Movies::getMoviesInfo($popular_movie,'video_access')=='Paid'): ?><span class="premium_video"><i class="fa fa-lock"></i>Premium</span><?php endif; ?>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/thesynccollectiv/public_html/resources/views/pages/movies_popular.blade.php ENDPATH**/ ?>